<template>
  <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-xl max-w-md w-full">
      <h2 class="text-2xl font-bold mb-4 text-gray-800 dark:text-white">{{ editWork ? 'Edit Deep Work' : 'Add New Deep Work' }}</h2>
      <input v-model="newWork.name" placeholder="Name" class="border p-2 mb-2 w-full rounded dark:bg-gray-700 dark:text-white">
      ...
      <div class="mb-4">
        <textarea 
          ...
          class="border p-2 mb-2 w-full rounded dark:bg-gray-700 dark:text-white" 
          rows="5"
        ></textarea>
      </div>
      
      <div class="mb-4">
        <p class="mb-2 text-gray-800 dark:text-white">Select hours:</p>
